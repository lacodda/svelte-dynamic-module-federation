# 📦A dynamic module federation built with Svelte
...
- [`svelte`](https://www.npmjs.com/package/svelte) - A framework for making user interfaces
- [`svelte-routing`](https://www.npmjs.com/package/svelte-routing) - Routing in Svelte
...
- [`svelte-loader`](https://www.npmjs.com/package/svelte-loader) - webpack loader for Svelte Single-File Components
